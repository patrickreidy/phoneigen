...
M1M3_raw <- 
  ...
  ggplot2::ggplot(mapping = ggplot2::aes(x = Centroid, y = Skewness,
                                         ...
                                         color = Sex)) +
  ggplot2::theme_bw() +
  ggplot2::theme(legend.position = c(0.3, 0.125), legend.direction = "horizontal") +
...
M1M3_normed <-
  ...
  ggplot2::scale_shape_manual(name = "", values = c("s" = 1, "S" = 5)) +
  ggplot2::scale_color_manual(name = "", values = c("F" = "#E98300", "M" = "#5BC6EB")) +
  ggplot2::scale_linetype_manual(name = "", values = c("s" = "dashed", "S" = "dotted")) +
  ggplot2::guides(shape = FALSE, color = FALSE, linetype = FALSE) +
  ggplot2::geom_point(size = 3) +
  ggplot2::stat_ellipse(type = "t", level = 0.95)
...
reduced %>%
  ...
  ggplot2::ggplot(mapping = ggplot2::aes(x = e1,  y = e2, color = Sex, 
                                         shape = TargetC, linetype = TargetC)) +
  ggplot2::theme_bw() +
  ggplot2::theme(legend.position = c(0.5, 0.125), legend.direction = "horizontal") +
...
sibilants_lda_sex_consonant <-
  ...
  ggplot2::scale_x_continuous(position = "top") +
  ggplot2::scale_shape_manual(values = c("s" = 1, "S" = 5)) +
  ggplot2::scale_color_manual(values = c("F" = "#E98300", "M" = "#5BC6EB")) +
  ggplot2::scale_linetype_manual(values = c("s" = "dashed", "S" = "dotted")) +
  ggplot2::guides(shape = FALSE, color = FALSE, linetype = FALSE) +
  ggplot2::geom_point(size = 3) +
  ggplot2::stat_ellipse(type = "t", level = 0.95)
...
sibilants_lda_participant_orthography <-
  ...
  ggplot2::ggplot(mapping = ggplot2::aes(x = LD1, y = LD2, color = Sex, 
                                         shape = TargetC, linetype = TargetC)) +
  ggplot2::theme_bw() +
  ggplot2::theme(legend.position = c(0.55, 0.875), legend.direction = "horizontal") +
  ggplot2::xlab("First linear discriminant") +
  ggplot2::ylab("Second linear discriminant") +
  ggplot2::scale_x_reverse(position = "top") +
...
stop_bursts_reduced %>%
  ...
  ggplot2::scale_shape_manual(values = c("Front" = 1, "Back" = 5)) +
  ggplot2::scale_linetype_manual(values = c("Front" = "dashed", "Back" = "dotted")) +
  ggplot2::scale_color_manual(values = c("th" = "#E98300", "kh" = "#008542")) +
  ggplot2::guides(shape = FALSE, color = FALSE, linetype = FALSE) +
  ggplot2::geom_point(size = 3) +
  ggplot2::stat_ellipse(type = "t", level = 0.95)
```
...
phoneigen::StopBursts() %>%
  ...
  ggplot2::ggplot(mapping = ggplot2::aes(x = LD1, y = LD2, color = TargetC, 
                                         shape = VowelPlace, linetype = VowelPlace)) +
  ggplot2::theme_bw() +
  ggplot2::xlab("First linear discriminant (LD1)") +
  ggplot2::ylab("Second linear discriminant (LD2)") +
  ggplot2::scale_shape_manual(values = c("Front" = 1, "Back" = 5)) +
  ggplot2::scale_linetype_manual(values = c("Front" = "dashed", "Back" = "dotted")) +
  ggplot2::scale_color_manual(values = c("th" = "#E98300", "kh" = "#008542")) +
  ggplot2::guides(shape = FALSE, color = FALSE, linetype = FALSE) +
